...
#ifndef COMPTONSOFT_AllSkyPrimaryGenerator_H
#define COMPTONSOFT_AllSkyPrimaryGenerator_H 1
...
/**
 * ComptonSoft PrimaryGenerator module for all-sky input via HEALPix.
 *
...
{
  DEFINE_ANL_MODULE(AllSkyPrimaryGenerator, 1.0);
public:
...
#endif /* COMPTONSOFT_AllSkyPrimaryGenerator_H */
