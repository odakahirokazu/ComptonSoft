...
#ifndef COMPTONSOFT_AEObservationPrimaryGenerator_H
#define COMPTONSOFT_AEObservationPrimaryGenerator_H 1
...
{
  DEFINE_ANL_MODULE(AEObservationPrimaryGenerator, 1.0);
public:
