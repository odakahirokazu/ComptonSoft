...
//
G4_DECLARE_PHYSCONSTR_FACTORY(CustomizedEmLivermorePolarizedPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

CustomizedEmLivermorePolarizedPhysics::CustomizedEmLivermorePolarizedPhysics(G4int ver, 
                                                                             const G4String&)
  : G4VPhysicsConstructor("CustomizedEmLivermorePolarized"), verbose(ver),
...
void CustomizedEmLivermorePolarizedPhysics::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void CustomizedEmLivermorePolarizedPhysics::ConstructProcess()
{
  if(verbose > 1) {
