  ...
  <xsl:template match="detector">
    ...
    <tr>
      ...
      <xsl:variable name="final_upside_anode">
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_upside_anode" />
          <xsl:with-param name="special" select="$upside_anode" />
        </xsl:call-template>
      </xsl:variable>
      <xsl:variable name="final_upside_pixel">
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_upside_pixel" />
          <xsl:with-param name="special" select="$upside_pixel" />
        </xsl:call-template>
      </xsl:variable>
      <xsl:variable name="final_upside_xstrip">
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_upside_xstrip" />
          <xsl:with-param name="special" select="$upside_xstrip" />
        </xsl:call-template>
      </xsl:variable>
      <td>
        <xsl:choose>
      ...
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_charge_collection_mode" />
          <xsl:with-param name="special" select="$charge_collection_mode" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_cce_map" />
          <xsl:with-param name="special" select="$cce_map" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_bias" />
          <xsl:with-param name="special" select="$bias" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_efield_mode" />
          <xsl:with-param name="special" select="$efield_mode" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_efield_p0" />
          <xsl:with-param name="special" select="$efield_p0" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_efield_p1" />
          <xsl:with-param name="special" select="$efield_p1" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_efield_p2" />
          <xsl:with-param name="special" select="$efield_p2" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_efield_p3" />
          <xsl:with-param name="special" select="$efield_p3" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_mutau_e" />
          <xsl:with-param name="special" select="$mutau_e" />
        </xsl:call-template>
      </td>
      <td>
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_mutau_h" />
          <xsl:with-param name="special" select="$mutau_h" />
        </xsl:call-template>
      </td>
      <xsl:variable name="final_diffusion_mode">
        <xsl:call-template name="disp_param">
          <xsl:with-param name="common" select="$com_diffusion_mode" />
          <xsl:with-param name="special" select="$diffusion_mode" />
        </xsl:call-template>
      </xsl:variable>
      <td>
      ...
      <xsl:choose>
        <xsl:when test="$final_diffusion_mode=1">
          <td>
            <xsl:call-template name="disp_param">
              <xsl:with-param name="common" select="$com_dif_factor_anode" />
              <xsl:with-param name="special" select="$dif_factor_anode" />
            </xsl:call-template>
          </td>
          <td>
            <xsl:call-template name="disp_param">
              <xsl:with-param name="common" select="$com_dif_factor_cathode" />
              <xsl:with-param name="special" select="$dif_factor_cathode" />
            </xsl:call-template>
          </td>
        </xsl:when>
        <xsl:when test="$final_diffusion_mode=2">
          <td>
            <xsl:call-template name="disp_param">
              <xsl:with-param name="common" select="$com_dif_const_anode" />
              <xsl:with-param name="special" select="$dif_const_anode" />
            </xsl:call-template>
            <xsl:text> cm</xsl:text>
          </td>
          <td>
            <xsl:call-template name="disp_param">
              <xsl:with-param name="common" select="$com_dif_const_cathode" />
              <xsl:with-param name="special" select="$dif_const_cathode" />
            </xsl:call-template>
            <xsl:text> cm</xsl:text>
          </td>
        </xsl:when>
