...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <table id="physical-config">
      <thead>
        <tr>
          ...
          <th colspan="3">Num Pixel</th>
	        <th colspan="3">Pixel Pitch</th>
          <th colspan="3">Position</th>
          <th colspan="3">X-axis Direction</th>
          <th colspan="3">Y-axis Direction</th>
          <th colspan="3">Z-axis Direction</th>
  ...
  <xsl:template match="detector">
    <tr>
      ...
      <td><xsl:value-of select="zaxis_direction/@x" /></td>
      <td><xsl:value-of select="zaxis_direction/@y" /></td>
